...
# we implemented beam seach, replication removal, <UNK> replacement, and "ensemble of models" (not ensemble decoding, the explanation is the the notebook)
# for beam seach, replication removal, and <UNK> replacement, please refer to neuralmt.py
...
# to allow "ensemble of models", in the translate function, now the "models" parameter takes an array of models.
# we add an additional parameter, weights, to describe the ensembling weights for each model
# for "ensemble of models", we also modified the main function so that 5 models are loaded
